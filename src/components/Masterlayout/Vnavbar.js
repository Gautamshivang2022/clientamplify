					...
					<div class="header-content">
						<nav class="navbar navbar-expand">
							<div class="collapse navbar-collapse justify-content-between">
								...
								<div style={{ height: "auto", width: "auto", position: "fixed",fontSize: "25px",color:'black',fontWeight:'500' }}>RealCoderz Meet</div>
								...
								<ul class="navbar-nav header-right">
									...
									<li class="nav-item dropdown notification_dropdown">
										<a class="nav-link bell ai-icon" role="button" data-toggle="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right">
											...
											<a class="all-notification">See all notifications <i
									...
									<li class="nav-item dropdown header-profile">
										<a class="nav-link"  role="button" data-toggle="dropdown">
											...
											<div class="header-info">
												<span>Hey, <strong>Roshua</strong></span>
										...
										<div class="dropdown-menu dropdown-menu-right">
											...
											<a  class="dropdown-item ai-icon" role="button"
